...
```
Save-PSResource [-Repository <String[]>] [-Credential <PSCredential>] [-AsNupkg] [-IncludeXml] -Path <String>
 [-TemporaryPath <String>] [-TrustRepository] [-PassThru] -InputObject <PSResourceInfo> [-SkipDependencyCheck]
