    ...
    public sealed class SavePSResource : PSCmdlet
    {
        ...
        public string Path
        {
            ...
            set
            {
                ...
                _path = GetResolvedProviderPathFromPSPath(Path, out ProviderInfo provider).First();
            }
        }
        ...
        public string TemporaryPath
        {
            ...
            set
            {
                ...
                // This will throw if path cannot be resolved
                _tmpPath = GetResolvedProviderPathFromPSPath(Path, out ProviderInfo provider).First();
            }
        }
