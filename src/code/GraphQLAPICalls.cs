...
{
    internal class GraphQLServerAPICalls : ServerApiCall
    {
        /*  ******NOTE*******:
        ...
        */
        ...
        public GraphQLServerAPICalls(PSRepositoryInfo repository, PSCmdlet cmdletPassedIn, NetworkCredential networkCredential, string userAgentString) : base (repository, networkCredential)
        {
