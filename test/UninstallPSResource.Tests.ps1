...
#         $modulePrereleaseLabel = ""
#         Get-ModuleResourcePublishedToLocalRepoTestDrive $publishModuleName $repoName "1.0.0.0" $modulePrereleaseLabel
#         Get-ModuleResourcePublishedToLocalRepoTestDrive $publishModuleName $repoName "3.0.0.0" $modulePrereleaseLabel
#         Get-ModuleResourcePublishedToLocalRepoTestDrive $publishModuleName $repoName "5.0.0.0" $modulePrereleaseLabel
...
#         Uninstall-PSResource -Name $testLocalModuleName, "test_module2" 
#         Get-PSResource $testLocalModuleName, "test_module2"  | Should -BeNullOrEmpty
#     }
...
#         $res = Get-PSResource -Name $testScriptName
#         $res | Should -BeNullOrEmpty
#         $res2 = Get-PSResource -Name $testLocalScriptName
...
#         # Get-ModuleResourcePublishedToLocalRepoTestDrive $publishModuleName $repoName "3.0.0.0" $modulePrereleaseLabel
#         # $null = Install-PSResource "TestMyLocalModule" -Version "3.0.0.0" -Repository "psgettestlocal" -TrustRepository -WarningAction SilentlyContinue
