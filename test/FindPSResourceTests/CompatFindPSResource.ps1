...
Describe 'Test compatpsget Find-PSResource for V2 Server Protocol' -tags 'CI' {
    ...
    AfterAll {
        ...
        # Expected Result: Should find a few modules
...
#            $res = Find-Module ContosoServer -Repository PSGallery
#            $res | Should -Not -BeNullOrEmpty 
#            $res.Name | Should -Be "ContosoServer"
#        }
    
        # Expected Result: Should find TestModule99 module
...
#            $res = Find-Module TestModule99 -RequiredVersion 12.0 -Repository PSGallery
#            $res | Should -BeNullOrEmpty
#        }
