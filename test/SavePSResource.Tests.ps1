...
Describe 'Test Save-PSResource for PSResources' {
    ...
    It "Save module that is not authenticode signed" -Skip:(!(Get-IsWindows)) {
        ...
        {}
        $Error[0].FullyQualifiedErrorId | Should -be "GetAuthenticodeSignatureError,Microsoft.PowerShell.PowerShellGet.Cmdlets.SavePSResource"
    }
    ...
    It "Save module with incorrect catalog file" -Skip:(!(Get-IsWindows)) {
        ...
        {}
        $Error[0].FullyQualifiedErrorId | Should -be "TestFileCatalogError,Microsoft.PowerShell.PowerShellGet.Cmdlets.SavePSResource"
    }
