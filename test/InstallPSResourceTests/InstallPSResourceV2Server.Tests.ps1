<<<<<<< HEAD:test/InstallPSResourceTests/InstallPSResourceV2Server.Tests.ps1
...
Describe 'Test Install-PSResource for Module' -Tags 'CI' {
...
#>
>>>>>>> 88723c729e65cf5b0fe77327e5e2521544ffcb2e:test/InstallPSResource.Tests.ps1
