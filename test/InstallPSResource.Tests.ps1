...
Describe 'Test Install-PSResource for Module' {
    ...
    It "Install module that is not authenticode signed" -Skip:(!(Get-IsWindows)) {
        ...
        {}
        $Error[0].FullyQualifiedErrorId | Should -be "GetAuthenticodeSignatureError,Microsoft.PowerShell.PowerShellGet.Cmdlets.InstallPSResource"
    }
    ...
    It "Install module with incorrect catalog file" -Skip:(!(Get-IsWindows)) {
        ...
        {}
        $Error[0].FullyQualifiedErrorId | Should -be "TestFileCatalogError,Microsoft.PowerShell.PowerShellGet.Cmdlets.InstallPSResource"
    }
